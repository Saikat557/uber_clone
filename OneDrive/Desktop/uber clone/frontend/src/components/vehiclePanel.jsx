...
<div className="w-full flex items-start justify-between  my-3 border-2 border-gray-100 p-2 rounded-md active:border-black">
...
<div className="w-full flex items-start justify-between border-2 border-gray-100 p-2 rounded-md my-3 active:border-black">
